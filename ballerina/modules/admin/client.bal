...
public isolated client class Client {
    ...
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/accounts/[string accountId]/dsgroups(int:Signed32? page = (), int:Signed32? page_size = ()) returns DSGroupListResponse|error {
    ...
    # + accountId - The account ID GUID.
    # + return - OK 
    resource isolated function post v2\.1/organizations/[string organizationId]/accounts/[string accountId]/dsgroups(DSGroupAddRequest payload) returns DSGroupResponse|error {
        string resourcePath = string `/v2.1/organizations/${getEncodedUri(organizationId)}/accounts/${getEncodedUri(accountId)}/dsgroups`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/accounts/[string accountId]/dsgroups/[string dsGroupId]() returns DSGroupResponse|error {
    ...
    # + return - No Content 
    resource isolated function delete v2\.1/organizations/[string organizationId]/accounts/[string accountId]/dsgroups/[string dsGroupId]() returns error? {
        string resourcePath = string `/v2.1/organizations/${getEncodedUri(organizationId)}/accounts/${getEncodedUri(accountId)}/dsgroups/${getEncodedUri(dsGroupId)}`;
    ...
    # + page_size - Page size of DSGroups.
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/accounts/[string accountId]/dsgroups/[string dsGroupId]/users(int:Signed32? page = (), int:Signed32? page_size = ()) returns DSGroupAndUsersResponse|error {
    ...
    # + dsGroupId - The DSGroup's GUID.
    # + return - OK 
    resource isolated function post v2\.1/organizations/[string organizationId]/accounts/[string accountId]/dsgroups/[string dsGroupId]/users(DSGroupUsersAddRequest payload) returns AddDSGroupAndUsersResponse|error {
        string resourcePath = string `/v2.1/organizations/${getEncodedUri(organizationId)}/accounts/${getEncodedUri(accountId)}/dsgroups/${getEncodedUri(dsGroupId)}/users`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + dsGroupId - The DSGroup's GUID.
    # + return - OK 
    resource isolated function delete v2\.1/organizations/[string organizationId]/accounts/[string accountId]/dsgroups/[string dsGroupId]/users(DSGroupUsersRemoveRequest payload) returns RemoveDSGroupUsersResponse|error {
        string resourcePath = string `/v2.1/organizations/${getEncodedUri(organizationId)}/accounts/${getEncodedUri(accountId)}/dsgroups/${getEncodedUri(dsGroupId)}/users`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + accountId - The account ID GUID.
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/accounts/[string accountId]/products/permission_profiles() returns ProductPermissionProfilesResponse|error {
    ...
    # + userId - The user ID GUID.
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/accounts/[string accountId]/products/users/[string userId]/permission_profiles() returns ProductPermissionProfilesResponse|error {
    ...
    # + userId - The user ID GUID.
    # + return - OK 
    resource isolated function post v2\.1/organizations/[string organizationId]/accounts/[string accountId]/products/users/[string userId]/permission_profiles(ProductPermissionProfilesRequest payload) returns UserProductPermissionProfilesResponse|error {
        string resourcePath = string `/v2.1/organizations/${getEncodedUri(organizationId)}/accounts/${getEncodedUri(accountId)}/products/users/${getEncodedUri(userId)}/permission_profiles`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
    ...
    # + accountId - The account ID GUID.
    # + return - OK 
    resource isolated function post v2\.1/organizations/[string organizationId]/accounts/[string accountId]/users(NewMultiProductUserAddRequest payload) returns AddUserResponse|error {
    ...
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/users/dsprofile(string? email = (), boolean? sort = ()) returns UsersDrilldownResponse|error {
    ...
    # + sort - When **true,** sorts the results in ascending order by account name.
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/users/[string userId]/dsprofile(boolean? sort = ()) returns UsersDrilldownResponse|error {
    ...
    # + accountId - The account ID GUID.
    # + return - OK 
    resource isolated function delete v2\.1/organizations/[string organizationId]/accounts/[string accountId]/products/users(UserProductProfileDeleteRequest payload) returns RemoveUserProductsResponse|error {
    ...
    # **Note:** This property is required.
    # + return - OK 
    resource isolated function get v2\.1/organizations/[string organizationId]/accounts/[string accountId]/products/permission_profiles/users(string? email = ()) returns UserProductPermissionProfilesResponse|error {
    ...
    # + accountId - The account ID GUID.
    # + return - OK 
    resource isolated function post v2\.1/organizations/[string organizationId]/accounts/[string accountId]/products/permission_profiles/users(UserProductPermissionProfilesRequest payload) returns UserProductPermissionProfilesResponse|error {
        string resourcePath = string `/v2.1/organizations/${getEncodedUri(organizationId)}/accounts/${getEncodedUri(accountId)}/products/permission_profiles/users`;
        http:Request request = new;
        json jsonBody = payload.toJson();
        request.setPayload(jsonBody, "application/json");
